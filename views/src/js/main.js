...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    // Returns the width for each pizza element based on size variable.
...
//Reduced pizza count to 48 based on a screen with of 2000 by 1300
